...
echo "PS: Os seus arquivos do projeto e a pasta local (${TARGET_DIR}) SERÃO MANTIDOS intactos."
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo "ℹ️  A pasta local com seus códigos fonte (${TARGET_DIR}) não foi alterada."
